...
- [[#languages-and-about-languages-on-the-beam][Languages, and about languages, on the BEAM]]
  - [[#overview][Overview]]
  - [[#32-languages-on-the-beam][32 Languages on the BEAM]]
...
** 32 Languages on the BEAM

First Erlang itself,
 then the  5 [[#lisps][Lisp-influenced]] languages,
 then the 14 [[#statically-typed-languages][statically-typed]] languages,
 then the 12 [[#etc][others]].  Including Erlang, that's 32 languages in all.
