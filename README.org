...
First Erlang itself,
 ...
 then the 11 [[#statically-typed-languages-11][statically-typed]] languages,
 then the 12 [[#etc-12][others]].  Including Erlang, that's 29 languages in all.
